...
public class PK10Service extends BaseService
{
    ...
    public Map<String, List<List<String>>> getData(final String date) {
        ...
        final List<PK10> list = this.dao.findByHql("from PK10 where openTime>:start and openTime <:end order by number asc", (Map<String, Object>)ImmutableMap.of((Object)"start", (Object)start, (Object)"end", (Object)end));
