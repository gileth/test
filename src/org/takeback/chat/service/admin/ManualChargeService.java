...
public class ManualChargeService extends MyListService
{
    ...
    public void save(final Map<String, Object> req) {
        ...
        if ("1".equals(status)) {
            ...
            final Integer uid = Integer.valueOf(data.get("uid"));
            final String tradeno = data.get("tradeno");
            final Double fee = (data.get("fee") == null) ? 0.0 : Double.valueOf(data.get("fee"));
            final Double gift = (data.get("gift") == null) ? 0.0 : Double.valueOf(data.get("gift"));
