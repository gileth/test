...
public class ExchangeAdminService extends MyListServiceInt
{
    ...
    public void save(final Map<String, Object> req) {
        ...
        final PubExchangeLog log = this.dao.findByHql(hql, (Map<String, Object>)ImmutableMap.of((Object)"id", (Object)id)).get(0);
        ...
        if ("2".equals(status) && !"2".equals(log.getStatus())) {
            ...
            this.dao.executeUpdate(upd, (Map<String, Object>)ImmutableMap.of((Object)"money", (Object)money, (Object)"uid", (Object)uid));
        }
