...
public class PcEggService extends BaseService
{
    ...
    public void bet(final Integer num, final String key, final Double money, final Integer uid, final String roomId) {
        ...
        final List<Double> curSum = this.dao.findByHql(curSumHql, (Map<String, Object>)ImmutableMap.of((Object)"num", (Object)num));
        ...
        final List<Double> sum = this.dao.findByHql(sumSql, (Map<String, Object>)ImmutableMap.of((Object)"num", (Object)num, (Object)"uid", (Object)uid));
        ...
        final int effected = this.dao.executeUpdate(moneyHql, (Map<String, Object>)ImmutableMap.of((Object)"money", (Object)money, (Object)"uid", (Object)uid));
        if (effected == 0) {
    ...
    public Double cancelBet(final Integer num, final Integer uid) {
        ...
        for (final PcGameLog log : list) {
            ...
            final int effected = this.dao.executeUpdate(logHql, (Map<String, Object>)ImmutableMap.of((Object)"id", (Object)log.getId()));
            if (effected == 1) {
                final String moneyHql = "update PubUser set money = COALESCE(money,0) + :money where id=:uid";
                this.dao.executeUpdate(moneyHql, (Map<String, Object>)ImmutableMap.of((Object)"money", (Object)log.getFreeze(), (Object)"uid", (Object)uid));
            }
        }
        return money;
    }
    ...
    public List<PcGameLog> getGameLog(final Integer num) {
        return this.dao.findByHql("from PcGameLog where num =:num and status =0", (Map<String, Object>)ImmutableMap.of((Object)"num", (Object)num));
    }
    ...
    public void open(final Integer num, final String exp, final String val) {
        ...
        final List<PcGameLog> gameRecs = this.dao.findByHql("from PcGameLog where num =:num and status =0", (Map<String, Object>)ImmutableMap.of((Object)"num", (Object)num));
        ...
        for (final PcGameLog l : gameRecs) {
            ...
            final List<Double> res = this.dao.findByHql(hql, (Map<String, Object>)ImmutableMap.of((Object)"num", (Object)num, (Object)"uid", (Object)l.getUid()));
            ...
            if (rate > 0.0) {
                ...
                l.setStatus("1");
                this.dao.executeUpdate("update PubUser set money = money +:bonus where id =:uid", (Map<String, Object>)ImmutableMap.of((Object)"bonus", (Object)bonus, (Object)"uid", (Object)l.getUid()));
            }
            else {
